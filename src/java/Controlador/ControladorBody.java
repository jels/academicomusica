...
public class ControladorBody {
    ...
    private String getViewIndexBoxSecre() {
        ...
        String htmlcode = "<!-- Bloque Superior (Matriculas y Estudiantes) -->\n"
                ...
                + "                                    </div>\n"
                + "                                    <div class=\"col-xs-9 text-right\">\n"
                + "                                        <div class=\"huge\">" + padres + "</div>\n"
                + "                                        <div>Padres</div>\n"
                + "                                    </div>\n"
                + "                                </div>\n"
                + "                            </div>\n"
                + "                            <a href=\"show_padres.jsp\">\n"
                + "                                <div class=\"panel-footer\">\n"
                + "                                    <span class=\"pull-left\">Ver Detalles</span>\n"
                + "                                    <span class=\"pull-right\"><i class=\"fa fa-arrow-circle-right\"></i></span>\n"
                + "                                    <div class=\"clearfix\"></div>\n"
    ...
    public String getViewNewEst() {
        ...
        String htmlcode = ""
                ...
                + "                                <input class=\"form-control\" id = \"primerNombreE\" placeholder=\"Primer Nombre\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                ...
                + "                                <input class=\"form-control\" id = \"primerApelidoE\" placeholder=\"Primer Apellido\">\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                ...
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>C.I.</label>\n"
                + "                                <input class=\"form-control\" id = \"ciE\" placeholder=\"Numero de CI\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Nacionalidad</label>\n"
                + "                                <input class=\"form-control\" id = \"nacionalidadE\" placeholder=\"Nacionalidad\" >\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                ...
                + "                                <input class=\"form-control\" id = \"direccionE\" placeholder=\"Direccion Estudiante\" >\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Telefono / Celular</label>\n"
                + "                                <input class=\"form-control\" id = \"telefonoE\" placeholder=\"N° de Telefono / Celular\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Fecha de Nacimiento</label>\n"
                + "                                <input class=\"form-control\" id = \"nacimientoE\" placeholder=\"YYYY-MM-DD\" pattern=\"^(19|20)+([0-9]{2})([-])([0-9]{1,2})([-])([0-9]{1,2})$\" title=\"YYYY-MM-DD\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Genero</label>\n"
                ...
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>E-Mail</label>\n"
                + "                                <input class=\"form-control\" id = \"emailE\" placeholder=\"ejemplo@ejemplo.com\" pattern=\"^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\\.[a-zA-Z0-9-]+)*$\" title=\"ejemplo@ejemplo.com\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
        ...
        htmlcode += "\n"
                ...
                + "                                <textarea class=\"form-control\" id=\"descripcionE\" rows=\"3\" style=\"width: 200px; height: 34px;\" placeholder=\"Estudios Realizados\" ></textarea>\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "\n"
                + "                        <h3 class=\"text-center\">Datos del Padre / Responsable</h3>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Primer Nombre</label>\n"
                + "                                <input class=\"form-control\" id = \"primerNombreP\" placeholder=\"Primer Nombre\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Segundo Nombre</label>\n"
                ...
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Primer Apellido</label>\n"
                + "                                <input class=\"form-control\" id = \"primerApelidoP\" placeholder=\"Primer Apellido\" >\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                ...
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>C.I.</label>\n"
                + "                                <input class=\"form-control\" id = \"ciP\" placeholder=\"Numero de CI\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Nacionalidad</label>\n"
                + "                                <input class=\"form-control\" id = \"nacionalidadP\" placeholder=\"Nacionalidad\" >\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                ...
                + "                                <input class=\"form-control\" id = \"direccionP\" placeholder=\"Direccion Padre\" >\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Telefono / Celular</label>\n"
                + "                                <input class=\"form-control\" id = \"telefonoP\" placeholder=\"N° de Telefono / Celular\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Fecha de Nacimiento</label>\n"
                + "                                <input class=\"form-control\" id = \"nacimientoP\" placeholder=\"YYYY-MM-DD\" pattern=\"^(19|20)+([0-9]{2})([-])([0-9]{1,2})([-])([0-9]{1,2})$\" title=\"YYYY-MM-DD\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Genero</label>\n"
                ...
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>E-Mail</label>\n"
                + "                                <input class=\"form-control\" id = \"emailP\" placeholder=\"ejemplo@ejemplo.com\" pattern=\"^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\\.[a-zA-Z0-9-]+)*$\" title=\"ejemplo@ejemplo.com\" >\n"
                + "                            </div>\n"
                + "                            <div class=\"col-md-4\">\n"
                + "                                <label>Grado Academico</label>\n"
                ...
                + "                        <div class=\"row show-grid\">\n"
                + "                            <div class=\"col-md-2\">\n"
                + "                                <input type=\"button\" id=\"newMatricula\" value=\"Crear\" class=\"btn btn-default\" />\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                        <div id=\"notificacionNewEst\"></div>\n"
                + "                    </form>\n";
    ...
    public String getViewCursoEst() {
        ...
        htmlcode += "</select>\n"
                ...
                + "                                <input class=\"form-control\" id=\"pagoTotal\" placeholder=\"Total en Bs.\" min=\"1\" title=\"Solo numeros...\" type=\"number\" required/>\n"
                + "                            </div>\n"
                + "                        </div>\n"
                + "                    </div>\n"
                + "                    <div class=\"row show-grid\">\n"
                ...
                + "                        </div>\n"
                + "                    </div>\n"
                + "                  <div id=\"notificacionCursoEstudiante\"></div>\n"
                + "                </form>";

        return htmlcode;
    }

    public String getViewNewPagos() {
        String htmlcode = "";
